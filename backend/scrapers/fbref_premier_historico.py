"""
FBref Premier League Historical Scraper
...
Solo inserta filas para jugadores que YA existen en Supabase con liga_id=24.
...
Uso (desde backend/):
  ...
  python scrapers/fbref_premier_historico.py
  python scrapers/fbref_premier_historico.py --temporada 2425
"""
...
# ---------------------------------------------------------------------------
# Cargar mapa de jugadores PL desde Supabase
# ---------------------------------------------------------------------------

def load_pl_jugadores() -> tuple[dict, dict]:
    """
    Carga todos los jugadores con equipo de liga_id=24.
    Devuelve:
    ...
    """
    log.info("[DB] Cargando jugadores Premier League (liga_id=%d)...", LIGA_ID)
...
# ---------------------------------------------------------------------------
# FBref: descargar standard stats para una temporada PL
# ---------------------------------------------------------------------------
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="FBref historico PL — solo standard stats")
    parser.add_argument(
        "--temporada",
        metavar="CLAVE",
